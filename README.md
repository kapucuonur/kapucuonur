...
| [DevChatbot-AI](https://github.com/kapucuonur/chatbotvoice-AI) **Backend (Python)** Flask, Flask-SQLAlchemy, Flask-Login, Flask-Migrate, Werkzeug.security, Groq, Flask-Dance (Facebook & Google OAuth), python-dotenv, Gunicorn, psycopg2-binary
**Frontend (Web)** HTML5, CSS3, JavaScript, Tailwind CSS, Web Speech API (SpeechRecognition, SpeechSynthesis) 
**Database** SQLite (Development), PostgreSQL (Production) | [Live Link](https://blog-app-python-2s96.onrender.com)
